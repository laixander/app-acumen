...
<template>
    <ContentPanel :title="title" back-link="/app/dashboard">
        <template #toolbar>
            <UBadge label="Reading & Video" variant="subtle" color="primary" />
        </template>

        <div class="w-full lg:max-w-5xl mx-auto flex flex-col gap-6">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="flex flex-col gap-6">
                    <!-- AI Tutor Prompt -->
                    <UCard class="border-2 border-primary-500/20 bg-primary-500/5"
