...
<template>
    <UDropdownMenu :items="items" :modal="false" :content="{ align: 'start', sideOffset: 8 }" :ui="{ content: 'w-56' }">
        ...
        >
            <div class="flex items-center justify-center w-7 h-7 rounded-md bg-primary-500/10 text-primary-500 group-hover:bg-primary-500 group-hover:text-white transition-all duration-300">
            ...
            <UIcon name="i-lucide-chevrons-up-down" class="w-3.5 h-3.5 text-neutral-400 group-hover:text-neutral-600 dark:group-hover:text-neutral-300 transition-colors" />
        </UButton>
    </UDropdownMenu>
</template>
